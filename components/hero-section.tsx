...
export function HeroSection() {
  ...
  return (
    <section className="relative bg-linear-to-br from-slate-900 to-slate-800 text-white h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-20 -left-20 w-72 h-72 bg-green-500/20 rounded-full blur-3xl animate-pulse-soft" />
      <div className="absolute bottom-20 -right-20 w-96 h-96 bg-amber-500/20 rounded-full blur-3xl animate-pulse-soft animation-delay-1000" />
